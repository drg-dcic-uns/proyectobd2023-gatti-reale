...
INSERT INTO Tarjetas (patente,saldo,tipo,id_tarjeta)
VALUES('ASD123', 600.00, 'B',2);
INSERT INTO Tarjetas (patente,saldo,tipo, id_tarjeta)
VALUES('FGH456', 700.00, 'C',3);
...
VALUES (1, 55555555, 'nombre1', 'Apellido1', md5('inspector'));
...
/*
*   dejamos estos casos de prueba comentados ya que no son de mucha utilidad, puesto que consumiria todo el saldo al cerrarlo luego de estar estacionado por dias
*
...
VALUES (1, 'ma', 't', 'Calle Principal', 100, 1);
INSERT INTO Asociado_con (id_asociado_con, dia, turno, calle, altura, legajo)
VALUES (2, 'ma', 't', 'Calle Secundaria', 150, 1);
